...
if (isset($_SESSION["uid"])) {
	...
	`city`, `state`, `pin`, `cardname`,`cardnumber`,`expdate`,`prod_count`,`total_amt`,`cvv`) 
	VALUES ($order_id, '$user_id','$f_name','$email', 
    '$address', '$city', '$state', '$pin','$cardname','$cardnumberstr','$expdate','$total_count','$prod_total','$cvv')";
    ...
    if(mysqli_query($con,$sql)){
        ...
        while($i<=$total_count){
            ...
            if(mysqli_query($con,$sql1)){
				...
				echo"<script>alert('Product will be delivered in 7 days! Please stay Tuned!');</script>";
